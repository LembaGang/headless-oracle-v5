...
const CLAUDE_MANAGED_AGENTS_MD = `# Using Headless Oracle with Claude Managed Agents
...
const DOCS_README_MD = `# Headless Oracle Documentation
...
- [MCP Reference](api/mcp-reference.md)
...
- [IP Ownership](legal/ip-ownership.md)
- [Data Processing](legal/data-processing.md)

## For Security
- [Security Overview](security/README.md)
- [Dependency Audit](security/dependency-audit.md)
- [License Policy](security/license-policy.md)
- [SBOM](security/sbom.json)
- [Secret Scan](security/secret-scan-results.md)
